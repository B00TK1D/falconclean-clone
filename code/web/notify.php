    ...
    <div class="div-block">
      <div class="w-form">
        <form action="/api/user/join.php" method="post" class="form">
            <label class="field-label-2">Please allow notifications so we can remind you when you're laundry's done!</label>
            <a class="submit-button w-button" id="push-subscription-button">Allow Notifications</a>
            <a href="/load.php" style="display:none" id="next">Next</a>
        </form>
      </div>
    </div>
